...
{
	/**
	 * Todo BootraiserManager as app->singleton
	 * @var BootraiserManager|null
	 */
	...
	public static function getPackageConfig(
		string $name,
		null|PackageConfig|ServiceProvider $config = null
	): PackageConfig {
	...
	{
		return (bool) ($this->packageConfigs[$name] ?? null);
	}
