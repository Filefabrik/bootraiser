...
test(
	...
	// cannot strip because different
	['/nothing/', '/var/www/html/my-vendor/cutse/', 'var/www/html/my-vendor/cutse'],
	['/var/www/html', '/var/www/html/my-vendor', 'my-vendor'],
]);
